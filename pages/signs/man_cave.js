        ...
        <div className="product-description-container">
          <div className="product-description">
            <p>
              ...
              gift for dads, husbands, and brothers who spend time in their man
              cave. Select an activity symbol to enhance the sign. It's sure to
              be the talk of all who see it.
            </p>
          </div>
